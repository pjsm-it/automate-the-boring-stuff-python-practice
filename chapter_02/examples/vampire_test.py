print("Hello possible fiend!\nWelcome to M.O.R.G.A.N.A - Monitoring of Rare Gothic and Nocturnal Anomalies")
...
if fiend_age < 12:
    ...
    print("1 - Stake to the heart\n2 - Sunlight\n3 - Cocktail spiked with holy water")

    # Escolha do método
    while True:
        extermination_method = input("Please, select an option (1-3): ").strip()
    ...
    if extermination_method in ["1", "2"]:
        print("Please walk to the red 'X' on the floor next to you and wait for extermination!")
    elif extermination_method == "3":
        print("Please wait for our mixologist robot to bring you your beverage!")
